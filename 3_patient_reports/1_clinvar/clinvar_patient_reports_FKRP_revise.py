#python clinvar_patient_reports_FKRP_revise.py FKRP_DiMSum_annotated_NEW_FINAL.tsv clinvar_result_FKRP_04202023.txt FKRP_conditions_NEW_FINAL
...
for i in range(1, len(in_tsv_lines)):
    ...
    classification=tsv_this_line[9]
    functional_score=tsv_this_line[15]
    Clinvar_clinical_significance=tsv_this_line[8]
