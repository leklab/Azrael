#Rscript --vanilla 2_pmid33200426_onset.r PMID_33200426_SMuRF
...
r = ggplot(df,aes(x=as.numeric(Onset_m), y=log2(fs1+fs2),color=Sex))+ geom_point(size=6)+ geom_smooth(method=lm,se=FALSE, size=1,linetype="dashed") + theme_bw()
