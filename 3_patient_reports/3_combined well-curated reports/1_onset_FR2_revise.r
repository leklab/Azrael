#Rscript --vanilla 1_onset_FR2_revise.r FKRPregstry_report_and_SMuRF_diumsum_NEW report_and_SMuRF_high_confidence_dimsum_NEW
...
ggsave(filename=paste(basename(args[1]),".onset2_revise.pdf",sep = ""),heigh=3)
