...
with open("Supplementary Table 5_updated_v2.tsv", 'r') as text:
...
for i in old[1:]:
    ...
    variant_key = 'chr22' + i[1] + rev(i[4]) + rev(i[5])
...
with open("Supplementary Table 5_updated_v3.tsv", 'w', newline='') as file:
