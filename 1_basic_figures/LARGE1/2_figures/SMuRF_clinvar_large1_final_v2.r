# Rscript --vanilla SMuRF_clinvar_large1_final_v2.r normalized_LARGE1_block1_func normalized_LARGE1_block2_func normalized_LARGE1_block3_func normalized_LARGE1_block4_func normalized_LARGE1_block5_func normalized_LARGE1_block6_func normalized_LARGE1_block7_func normalized_LARGE1_block8_func normalized_LARGE1_block9_func normalized_LARGE1_block10_func
...
p = p + geom_boxplot()+geom_signif(comparisons = list(c("B/LB", "VUS")),y_position=4)+geom_signif(comparisons = list(c("B/LB", "P/LP")),y_position=4.4)+geom_signif(comparisons = list(c("VUS", "P/LP")),y_position=3.6)
...
ggsave(filename="SMuRF_clinvar_large1_v2.png",dpi=300)
