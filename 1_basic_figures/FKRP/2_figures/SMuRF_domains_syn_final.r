#Rscript --vanilla SMuRF_domains_syn_final.r normalized_FKRP_block1_func normalized_FKRP_block2_func  normalized_FKRP_block3_func normalized_FKRP_block4_func normalized_FKRP_block5_func normalized_FKRP_block6_func
...
ggsave(filename="SMuRF_domains_syn.png",dpi=300)
