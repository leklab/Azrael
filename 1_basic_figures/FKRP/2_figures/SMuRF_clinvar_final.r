#Rscript --vanilla SMuRF_clinvar_final.r normalized_FKRP_block1_func normalized_FKRP_block2_func  normalized_FKRP_block3_func normalized_FKRP_block4_func normalized_FKRP_block5_func normalized_FKRP_block6_func
...
p = p+scale_fill_manual(values=c("darkgreen", "darkgreen","darkgreen","red","red","red","lightblue"))
...
ggsave(filename="SMuRF_clinvar.png",dpi=300, width=14)
