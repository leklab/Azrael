#Rscript --vanilla 1_onset_FR_revise.r FKRPregstry_report_and_SMuRF_diumsum report_and_SMuRF_high_confidence_dimsum
...
ggsave(filename=paste(basename(args[1]),".onset.png",sep = ""),dpi=300, height=3)
