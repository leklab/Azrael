#Rscript --vanilla 2_onset_revise.r report_and_SMuRF_high_confidence_dimsum
...
r = r + theme(axis.text.x=element_text(size=20,colour="black",family="Atlas Grotesk Web Bold"),axis.title.x =element_text(size=30,colour="black",family="Atlas Grotesk Web Bold",vjust=1.5))
...
r = r + theme(legend.position=c(0.9, 0.88),legend.title=element_text(colour="black",size=18,family="Atlas Grotesk Web Bold"))
...
ggsave(filename=paste(basename(args[1]),".onset_revise.png",sep = ""),dpi=300)
