#python clinvar_patient_reports_FKRP_revise.py FKRP_DiMSum_annotated.tsv clinvar_result_FKRP_04202023.txt FKRP_conditions
...
for i in range(1, len(in_tsv_lines)):
    ...
    functional_score=tsv_this_line[41]
