#Rscript --vanilla SMuRF_domains_large1_syn_revise.r LARGE1_DiMSum_annotated_v2.tsv
...
r = r + theme(axis.text.x=element_text(size=20,colour="black",family="Atlas Grotesk Web Bold"),axis.title.x =element_text(size=10,colour="black",family="Atlas Grotesk Web Bold",vjust=1.5))
...
ggsave(filename="SMuRF_domains_large1_syn_revise_high_confi.png",dpi=300)
