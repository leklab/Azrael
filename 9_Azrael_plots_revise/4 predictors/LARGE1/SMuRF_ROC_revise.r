...
# Add legend with AUC values
 legend_text <- c(paste0("MAVERICK (AUC=", round(auc(roc_maverick), 2), ")"),
 ...
 legend("bottomright", legend = legend_text, col = c("black", "lavender", "darkgreen",'purple', "gainsboro", 'lightpink','blue',"lightblue" ,"mistyrose" ,"green",'orange'), lwd = 4,cex=0.34)
...
#                 paste0("metaSVM (AUC=", round(auc(roc_data_metaSVM), 2), ")"),
#                 paste0("SMuRF (AUC=", round(auc(roc_data_smurf), 2), ")"))
#legend("bottomright", legend = legend_text, col = c("lavender", "black","darkgreen", "purple", "lightpink", 'blue','gainsboro',"mistyrose" ,"green" ,"lightblue",'orange'), lwd = 4,cex=0.34)
