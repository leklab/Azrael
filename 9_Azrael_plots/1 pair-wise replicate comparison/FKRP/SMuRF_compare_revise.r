...
################
s = s + labs(caption = paste("Spearman's rho:", round(cor(exp1$functional_score, exp1$b2functional_score, method = "spearman",use = "complete.obs"), 2)))+theme(plot.caption.position = "plot",plot.caption = element_text(vjust=18,size=17,hjust=0.16))
...
#################
#ggsave(filename="compare_revise_0v1.pdf")
ggsave(filename="compare_revise_0v2.pdf")
