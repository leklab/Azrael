#Rscript --vanilla SMuRF_ROC_revise.r FKRP_DiMSum_annotated_NEW_FINAL.tsv
...
#pdf(file=paste(basename(args[1]),".ROC_rev_hi_confi_1.4E5.noEVE.pdf",sep = ""),width=4, height=4)
par(bg=NA)
...
legend("bottomright", legend = legend_text, col = c("lavender", "lightblue","darkgreen", "gainsboro", "lightpink", 'black','purple',"mistyrose" ,"blue" ,"green",'orange'), lwd = 4,cex=0.46)
#legend("bottomright", legend = legend_text, col = c("lavender", "lightblue","darkgreen", "gainsboro", "lightpink", 'black','purple',"mistyrose" ,"green",'orange'), lwd = 4,cex=0.46)
