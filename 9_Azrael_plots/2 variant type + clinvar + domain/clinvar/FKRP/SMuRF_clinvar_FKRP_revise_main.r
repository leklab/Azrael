# Rscript --vanilla SMuRF_clinvar_FKRP_revise_main.r FKRP_DiMSum_annotated_NEW.tsv
...
p = p + theme(axis.text.x=element_text(size=25,colour="black"),axis.title.x = element_blank())
...
p = p + labs(title="FKRP Missense", subtitle=paste(variant_count_number,"variants"))



ggsave(filename="SMuRF_clinvar_FKRP_revise_main_high_confidence.pdf")
