# Rscript --vanilla SMuRF_clinvar_large1_revise.r LARGE1_DiMSum_annotated_v2.tsv
...
p = p + scale_color_manual(values=c("darkgreen", "darkgreen","darkgreen","red","lightblue"))
...
p = p + theme(axis.text.y=element_text(size=18,colour="black"),axis.title.y=element_text(size=18,colour="black",vjust=1.5))
...
p = p + theme(axis.ticks=element_blank(),plot.title=element_text(size=20),plot.subtitle=element_text(size=18))
...
ggsave(filename="SMuRF_clinvar_large1_revise_high_confidence.pdf",width=7)
