#Rscript --vanilla SMuRF_FKRP_combine_plot_revise.r FKRP_DiMSum_annotated_NEW.tsv
...
ggsave(filename="SMuRF_FKRP_scores_combined_style_withnumber_revised_high_confidence.pdf")
#ggsave(filename="SMuRF_FKRP_scores_combined_style_withnumber_revised.pdf")
